  ...
  return <div className="w-[83%] flex flex-col gap-8">
    ...
    <div className="w-full px-10 flex items-center gap-8 justify-start overflow-x-scroll">
    {
      topCast.map((cast) => {
        ...
        return <div key={cast.id} id={cast.id} className="flex flex-col items-center text-center gap-4">
          <div className="w-[12rem] h-[12rem] rounded-[50%]">
            <img src={profileImg} alt="" className="rounded-[50%] object-cover w-full h-full" />
          </div>
